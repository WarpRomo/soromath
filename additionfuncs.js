function additioninit(){
  ...
  document.getElementById("additioninput").focus();
...
function addaddition(main=false,setproblem=null,difficulty=0){
  ...
  if(setproblem == null) additionproblems.push([num1,num2]);
  else{
     additionproblems.push(setproblem);
     num1 = setproblem[0]
     num2 = setproblem[1]
  }
...
function additionenter(e){
  ...
  if(e.key == "Enter" || e.key==" "){
    ...
    let problem = additionproblems[problemindex]
